...
class DiffTf:
    def __init__(self):
        ...
        # subscriptions
        rospy.Subscriber("enc2", Float64, self.lwheelCallback)
        rospy.Subscriber("enc1", Float64, self.rwheelCallback)
